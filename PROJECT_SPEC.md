...
- **Basis:** Ableger von [WEBXR_TEST](https://github.com/WEFOTH/WEBXR_TEST) (Smartphone-Variante, dient als `upstream`)

## Anforderungen (umgesetzt)

Alle funktionalen Anforderungen des Hauptprojekts (siehe [WEBXR_TEST/PROJECT_SPEC.md](https://github.com/WEFOTH/WEBXR_TEST/blob/main/PROJECT_SPEC.md)), zusätzlich:
